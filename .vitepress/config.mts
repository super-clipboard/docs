...
// Auto-generated by `pnpm run docs:api` (TypeDoc + typedoc-vitepress-theme).
// Safe to import; the file is regenerated before each dev/build.
let typedocSidebar: DefaultTheme.SidebarItem[] = [];
let typedocSidebarZh: DefaultTheme.SidebarItem[] = [];
try {
  // eslint-disable-next-line @typescript-eslint/no-require-imports
  typedocSidebar = require("../reference/api/typedoc-sidebar.json");
} catch {
  // Sidebar JSON missing — `pnpm run docs:api` hasn't run yet.
}
try {
  // eslint-disable-next-line @typescript-eslint/no-require-imports
  typedocSidebarZh = require("../zh/reference/api/typedoc-sidebar.json");
} catch {
  // Sidebar JSON missing — `pnpm run docs:api` hasn't run yet.
}
  ...
  "/scripts/": [
    ...
    },
    {
      ...
      items: [
        ...
        { text: "Grants & Permissions", link: "/scripts/grants" },
  ...
  "/reference/": [
    {
      text: "Reference",
      items: [
        { text: "Overview", link: "/reference/global-native-api" },
      ],
    },
    {
      text: "API (auto-generated)",
  ...
  "/zh/scripts/": [
    ...
    },
    {
      ...
      items: [
        ...
        { text: "Grant 与权限", link: "/zh/scripts/grants" },
  ...
  "/zh/reference/": [
    {
      text: "参考",
      items: [
        { text: "概览", link: "/zh/reference/global-native-api" },
      ],
    },
    {
      text: "API（自动生成·英文）",
      items: typedocSidebarZh,
    },
  ],
};
